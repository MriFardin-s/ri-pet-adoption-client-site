...
export default function MyRequestsPage() {
  ...
  if (sessionLoading || isLoading)  return (
    <div className="min-h-screen flex items-center justify-center bg-base-300/40 dark:bg-pink-950/20">
  ...
  return (
    <div className="bg-base-300/40 dark:bg-pink-950/20 p-6 max-w-6xl mx-auto">
