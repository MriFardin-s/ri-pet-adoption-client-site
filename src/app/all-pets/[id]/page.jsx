            ...
            <div className="p-6 sm:p-8 space-y-6 flex-1">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 border-b border-slate-100 dark:border-zinc-800 pb-4">
                <div>
                  ...
                  <div className="mt-2">
                    <span className={`px-3 py-1 rounded-full text-[10px] font-black uppercase border ${(pet.status || "").toUpperCase() === "ADOPTED"
                      ...
                      : (pet.status || "").toUpperCase() === "PENDING"
                        ? "bg-amber-50 dark:bg-amber-950/30 text-amber-600 border-amber-100 dark:border-amber-900/50"
                        : "bg-sky-50 text-sky-600 dark:bg-sky-950/30 dark:text-sky-400 dark:border-sky-900/50 border-sky-100"
                      }`}>
                      {
                        (pet.status || "").toUpperCase() === "ADOPTED" ? "Adopted" :
                          (pet.status || "").toUpperCase() === "PENDING" ? "Pending" : "Available"
                      }
                    </span>
                  </div>
