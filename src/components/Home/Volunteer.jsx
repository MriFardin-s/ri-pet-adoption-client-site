  ...
  return (
    <section className="bg-gradient-to-tr from-pink-50 to-pink-100/40 dark:from-pink-950/10 dark:to-base-200 border-t border-pink-100 dark:border-pink-950 py-16 sm:py-20 text-center">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        <div className="pt-2">
         <button className="px-8 py-3 !text-white font-bold rounded-xl shadow-md transition-all duration-300 transform hover:-translate-y-0.5 active:translate-y-0 !bg-gradient-to-r !from-[#FF94B9] !via-[#FFB7D2] !to-[#FFE3EC] dark:!text-white dark:!from-[#4A1525] dark:!to-[#2A0813] text-pink-950">
  Join Our Crew
</button>
        </div>
      </div>
