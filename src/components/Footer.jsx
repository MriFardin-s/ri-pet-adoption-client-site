    ...
    <footer className="bg-linear-to-b from-pink-50/50 to-pink-100/80 dark:from-base-200 dark:to-base-300 text-base-content border-t border-pink-200/40 transition-colors duration-300 mt-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="flex items-center justify-center">
          <div className="mt-12 pt-6 border-t border-pink-200/50 dark:border-pink-900/30 text-center text-sm font-semibold text-slate-500 dark:text-pink-400/50 flex items-center justify-center gap-1.5">
