  ...
  return (
    <footer className="bg-linear-to-b from-pink-50/50 to-pink-100/80 dark:from-base-200 dark:to-base-300 text-base-content border-t border-pink-200/40 transition-colors duration-300 mt-auto">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="space-y-3">
            ...
            <div className="flex space-x-3 pt-1">
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
                href="#" 
                className="btn btn-circle bg-white hover:bg-pink-600 text-[#1877F2] hover:text-white border border-pink-100 dark:border-none shadow-sm text-lg flex items-center justify-center"
                aria-label="Facebook"
              >
                <FaFacebookF />
              </motion.a>
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
                href="#" 
                className="btn btn-circle bg-white hover:bg-gradient-to-tr hover:from-yellow-500 hover:to-purple-600 text-[#E4405F] hover:text-white border border-pink-100 dark:border-none shadow-sm text-lg flex items-center justify-center"
              ...
              <motion.a 
                ...
                whileTap={{ scale: 0.95 }}
                href="#" 
                className="btn btn-circle bg-white hover:bg-sky-500 text-[#1DA1F2] hover:text-white border border-pink-100 dark:border-none shadow-sm text-lg flex items-center justify-center"
                aria-label="Twitter"
              >
                <FaTwitter />
              </motion.a>
        ...
        <div className="mt-12 pt-6 border-t border-pink-200/50 dark:border-pink-900/30 text-center text-sm font-semibold text-slate-500 dark:text-pink-400/50">
          © {currentYear || "2026"}{" "}
          <span className="text-pink-600 dark:text-pink-400">PetAdopt</span> Platform. All rights reserved.
        </div>
